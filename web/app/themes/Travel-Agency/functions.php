...
require get_template_directory() . "/inc/admin-menu/contacts-menu.php";
...
function travelAgency_admin_scripts()
{
...
add_action("admin_enqueue_scripts", "travelAgency_admin_scripts");
